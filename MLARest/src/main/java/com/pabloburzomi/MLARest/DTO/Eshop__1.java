...
public class Eshop__1 {

    @JsonProperty("nick_name")
    private String nickName;
    @JsonProperty("eshop_rubro")
    private EshopRubro__1 eshopRubro;
    @JsonProperty("eshop_id")
    private Long eshopId;
    @JsonProperty("eshop_locations")
    private List<EshopLocation__1> eshopLocations = new ArrayList<EshopLocation__1>();
    ...
    @JsonProperty("eshop_rubro")
    public EshopRubro__1 getEshopRubro() {
        return eshopRubro;
    }

    @JsonProperty("eshop_rubro")
    public void setEshopRubro(EshopRubro__1 eshopRubro) {
    ...
    @JsonProperty("eshop_locations")
    public List<EshopLocation__1> getEshopLocations() {
        return eshopLocations;
    }

    @JsonProperty("eshop_locations")
    public void setEshopLocations(List<EshopLocation__1> eshopLocations) {
